...
def h5py_update(data):
  ...
  if 'atoms' not in h5f.keys():
    ...
    h5f.create_dataset('state_enes', (0, nstates) , maxshape=(None, nstates), dtype='float64')
...
def h5py_copy_partial(oldh5f, lastframe, config):
  ...
  h5f.create_dataset('state_enes', (lastframe, nstates) , maxshape=(None, nstates), dtype='float64')
